  ...
  <div class="nav-wrapper white">
    <div class="container">  
      ...
      <ul id="nav-mobile" class="right hide-on-med-and-down">
        ...
        <li><a href="{{ url('/daftar') }}" class="waves-effect waves-light btn">Daftar</a></li>
    </div>
  </div>
</nav>
    ...
    <div class="section">
      <div class="row">
        <div class="col s12 m12 l12">
          ...
          <a class="waves-effect waves-light btn-large col s12" href="{{ url('/daftar') }}">Daftar Sekarang</a>
        </div>
      </div>
    </div>
  {{-- PRODUK --}}
