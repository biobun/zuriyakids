 <!-- jQuery Library -->
    ...
    <script type="text/javascript" src="{{ URL::asset('js/plugins/angular.min.js') }}"></script>    
    ...
    {{-- sweetalert --}}
    <script type="text/javascript" src="{{ URL::asset('js/plugins/sweetalert/sweetalert.min.js') }}"></script>   
